...
const SOCIALS = [
  ...
  {
    label: "LinkedIn", href: "https://www.linkedin.com/in/midhula-j-philip-8636982bb",
          ...
          <div className="hero-left-mobile flex flex-col items-center md:items-start text-center md:text-left gap-6 order-2 md:order-1">
            ...
            */}
            ...
            <p className="hau3 hero-f-body hero-desc-mobile max-w-lg text-[0.92rem] sm:text-[0.98rem] leading-relaxed font-normal text-slate-500 dark:text-slate-400">
              To be part of an enthusiastic work environment where I can further enhance
              my knowledge and apply my technical skills in HTML, CSS, Python, and SQL to
              effectively contribute to the organization's goals.
            </p>
            ...
            */}
            <div className="hau4 w-full sm:w-auto">
              <a
                href="/resume.pdf"
                download="Midhula_Jessy_Philip_Resume.pdf"
            ...
            */}
            ...
            >
              ...
              <div className="relative z-10 w-full h-full rounded-full overflow-hidden"
                ...
                <img src={profilePic} alt="Midhula Jessy Philip" className="w-full h-full object-cover" />
              </div>
            </div>

            {/* Name tag — UNCHANGED */}
            <div className="text-center">
              <p className="hero-f-display text-[0.58rem] font-bold tracking-[0.28em] uppercase text-slate-400/60 dark:text-white/20">Midhula Jessy Philip</p>
              <div className="flex items-center justify-center gap-2 mt-1">
                <div className="w-5 h-px bg-blue-400/30" />
                <p className="hero-f-body text-[0.5rem] tracking-[0.2em] uppercase text-slate-400/50 dark:text-white/15">Fresher</p>
