...
const INFO = [
  {
    label: "Email", value: "midhulajphilip003@gmail.com",
    href: "mailto:midhulajphilip003@gmail.com", accent: "#3b82f6", rgb: "59,130,246",
    icon: (c) => (
  ...
  {
    label: "Phone", value: "+91 8328392002",
    href: "tel:+918328392002", accent: "#8b5cf6", rgb: "139,92,246",
    icon: (c) => (
      <svg viewBox="0 0 24 24" width="20" height="20" fill="none"
        stroke={c} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await emailjs.send(EJS_SERVICE_ID, EJS_TEMPLATE_ID, {
        ...
        to_email: "midhulajphilip003@gmail.com",
      }, EJS_PUBLIC_KEY);
      setSendState("sent");
