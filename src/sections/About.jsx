...
const SKILLS = ["HTML5","CSS3","Python","SQL","DBMS","RDBMS","Joins","Functions","OOP Concepts","Loops & Control Flow","Lists & Tuples","Dictionaries","File Handling","Web Applications","Multimedia Tags","CSS Selectors"];
const STATS  = [{ val:"Fresher",label:"Experience Level" },{ val:"3+",label:"Projects Completed" },{ val:"4+",label:"Tech Stacks" },{ val:"3",label:"Languages Known" }];
const VALUES = [
      ...
      <div className="max-w-6xl mx-auto px-6 sm:px-10 lg:px-16 py-24 lg:py-32">
        ...
        <div className={`ab-reveal ${secVis?"ab-visible":""} mb-16 px-8 py-8 rounded-2xl border border-slate-200 dark:border-white/[0.07] bg-white dark:bg-white/[0.025] relative overflow-hidden`}>
          ...
          <p className="ab-f-serif relative z-10 text-slate-500 dark:text-white/65"
            ...
            "Knowledge grows when shared — I aim to apply my technical skills to contribute meaningfully to every team I am part of."
          </p>
          <p className="ab-f-body mt-4 text-[0.7rem] tracking-[0.18em] uppercase text-slate-400 dark:text-white/28 relative z-10">— Midhula Jessy Philip</p>
        </div>
        ...
        <div ref={bodyRef} className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start mb-16">
          ...
          <div className={`ab-reveal ${bodyVis?"ab-visible":""}`}>
            <div className="relative rounded-2xl overflow-hidden aspect-[4/5] bg-slate-100 dark:bg-white/[0.04] border border-slate-200 dark:border-white/[0.08]">
              <img src={aboutImage} alt="Midhula Jessy Philip" className="w-full h-full object-cover" />
          ...
          <div className={`ab-reveal ab-d2 ${bodyVis?"ab-visible":""} flex flex-col gap-7`}>
            <div>
              <h3 className="ab-f-display text-[1.05rem] font-bold tracking-[0.12em] uppercase text-slate-900 dark:text-white mb-2">Midhula Jessy Philip</h3>
              <p className="ab-f-serif text-[1.0rem] font-light italic text-slate-500 dark:text-white/45">Fresher · Based in India</p>
            </div>

            <div className="space-y-3">
              <p className="ab-f-body text-[0.92rem] leading-relaxed font-light text-slate-600 dark:text-white/55">
                I'm a fresher with a Bachelor of Technology in ECE from Priyadarshini College of Engineering and Technology, Nellore. I'm passionate about web development and programming, with hands-on skills in HTML, CSS, Python, and SQL.
              </p>
              <p className="ab-f-body text-[0.88rem] leading-relaxed font-light text-slate-500 dark:text-white/40">
                I enjoy building clean web pages and applications, and I'm eager to contribute to a team where I can keep learning and growing. Proficient in English, Malayalam, and Telugu.
              </p>
            </div>
