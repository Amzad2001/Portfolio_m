...
const PROJECTS = [
  { id:1, title:"Nxt Trendz – E-Commerce Frontend", desc:"Responsive e-commerce app with authentication, protected routes, product listing and cart management using Context API.", thumb:nxtTrend, color:"0,191,255", accent:"#00bfff", tags:["React","JWT","Tailwind CSS","REST APIs"], live:"https://nexttrendsse.ccbp.tech", source:"#" },
  { id:2, title:"Nxt Watch – Video Streaming Platform", desc:"YouTube-like platform with login, protected routes and video browsing. JWT authentication and REST APIs for secure access.", thumb:nextWatch, color:"185,78,255", accent:"#b94eff", tags:["React","JWT","Tailwind CSS","REST APIs"], live:"https://youte2.ccbp.tech", source:"#" },
  { id:3, title:"Portfolio Website", desc:"Personal portfolio showcasing projects, skills and experience. React + Tailwind with dark/light theme system.", thumb:portfolioImg, color:"0,255,136", accent:"#00ff88", tags:["React","Tailwind CSS","JavaScript","Vercel"], live:"https://my-portifolio-jet-zeta.vercel.app", source:"#" },
  { id:4, title:"Jobby App – Job Search Platform", desc:"Job portal with authentication, filters and detail views. Handles loading, failure states and reusable components.", thumb:jobbyApp, color:"255,159,67", accent:"#ff9f43", tags:["React","JWT","Tailwind CSS","REST APIs"], live:"https://jobygane.ccbp.tech", source:"#" },
  { id:5, title:"PrimeCommerce – Full Stack App", desc:"Full-stack e-commerce with RESTful APIs, JWT auth, login/logout and password recovery workflows.", thumb:binkit, color:"255,45,120", accent:"#ff2d78", tags:["React","Node.js","MongoDB","REST APIs"], live:"#", source:"#" },
];
